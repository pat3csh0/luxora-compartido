# URLs del verificador de email — v4.0.0
...
Versión fija v4.0.0 (no recibe mejoras, no cambia nunca):
```html
...
| `@v4.0.0` | No — siempre la misma versión exacta | Nunca |

**Para la mayoría de usuarios:** usa `@main`. Es la recomendada.

**Usa `@v4.0.0`** solo si necesitas que el comportamiento no cambie nunca (ej: auditorías, tests, entornos regulados).
...
| Release v4.0.0 | https://github.com/pat3csh0/luxora-compartido/releases/tag/v4.0.0 |
