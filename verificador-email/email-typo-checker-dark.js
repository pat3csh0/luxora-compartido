/*
  Verificador de typos en email — VARIANTE DARK (texto claro)
  Para landings de fondo oscuro (negro, gris oscuro, azul marino).
...
(function () {
  ...
  // ── UI: caja de sugerencia (variante DARK — texto claro) ─
